...
function postSession(request, callback){
    db.query(`INSERT INTO Session (date, studentId, courseId, temperature, luminosity, noise) VALUES ('${convertDate()}','${request.studentId}', '${request.courseId}', '${request.temperature}', '${request.luminosity}', '${request.noise}')`, (response) => {
